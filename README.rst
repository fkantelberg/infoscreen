Odoo modules built for an IoT system using a Raspberry Pi with attached touch screen and further IoT sensors/actors. These modules are intended to run only in a private network and environment.
